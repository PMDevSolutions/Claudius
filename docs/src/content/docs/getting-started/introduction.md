...
- [Quick start](/getting-started/quick-start/) — embed the widget in 5 minutes
- [Local development](/getting-started/local-development/) — run widget and worker locally
- [Configuration](/configuration/widget/) — every option, with defaults
- [Deployment](/deployment/worker/) — ship the worker and the embed
