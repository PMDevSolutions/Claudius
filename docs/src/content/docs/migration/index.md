...
description: How Claudius versions releases, the CDN channels, and how these docs are archived.
sidebar:
  order: 1
---
...
- **Major** (`1.x` → `2.0`) — may contain breaking changes, always with a
  [migration guide](/migration/v1-2-to-v1-3/). The `@1` CDN channel never
