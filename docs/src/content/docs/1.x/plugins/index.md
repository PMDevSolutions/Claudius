...
|-----------------|------------------|
| [System prompt](/1.x/configuration/worker/#system-prompt) (`worker/src/system-prompt.ts`) | The bot's personality, knowledge, guardrails, and FAQ answers |
| [Translations](/1.x/configuration/localization/) | Every user-facing UI string |
| [Theming options](/1.x/configuration/theming/) and `widget/tailwind.config.ts` | Colors, fonts, radii |
| [Proactive triggers](/1.x/configuration/triggers/) | When the widget opens or greets proactively |
