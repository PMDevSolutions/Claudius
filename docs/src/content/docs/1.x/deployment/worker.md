...
description: Ship the Cloudflare Worker with rate limiting, secrets, CORS, and
  optional analytics.
sidebar:
  order: 1
slug: 1.x/deployment/worker
---
...
[Worker settings](/1.x/configuration/worker/) for defaults.
