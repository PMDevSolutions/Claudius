...
- Business: PMDS - Paul Mulligan Development Solutions
- Owner: Paul Mulligan, Freelance Web Developer
- Location: 5616 Winthrope Ave, Baltimore, MD 21214
- Phone: (443) 866-7356
- Email: paul@pmds.info
- Hours: Monday - Saturday, 9:00 AM - 8:00 PM EST
- Email response time: Within 24 hours
- Experience: 10+ years, 50+ sites built
- Service area: Baltimore, MD; DC area; Philadelphia; works remotely with clients across the US
...
1. **Free 30-minute consultation** — Understand your goals, no pressure.
2. **Clear proposal** — Exact pricing, timeline, deliverables, no hidden fees.
3. **Build & launch** — Regular check-ins, most sites launch in 2-6 weeks.
...
5. **Do your websites come with SEO?**
Yes, comprehensive SEO is included at no extra cost with every website build.

6. **How long does SEO take to show results?**
3-6 months for meaningful improvements in search rankings and traffic.

7. **What's your process for new projects?**
Free consultation, then a clear proposal, then build with regular check-ins throughout.

8. **Do you offer ongoing support after launch?**
Yes. $60/month hosting and maintenance package includes daily backups, updates, security monitoring, and priority support.

9. **Where are you located?**
Baltimore, MD. Paul works remotely with clients across the US, including the DC area and Philadelphia.

10. **Do I own my website after it's built?**
Yes, 100%. All files, credentials, and documentation are handed over to you.

11. **What if I just need small changes?**
$75/hr for content updates, bug fixes, design refresh, or any small changes to an existing site.

12. **What if I'm not happy with the design?**
Revision rounds are built into every package, and there are approval checkpoints throughout the process so you're never surprised.

13. **How do you handle website content?**
Paul guides you through what's needed and can work with rough notes, outlines, or existing content to create polished pages.

14. **Can you help with Google Business Profile?**
Yes, Google Business Profile setup and optimization is included with SEO services.
...
Schedule a free consultation at https://pmds.info/contact. Paul will learn about your project and provide a no-obligation proposal.
...
- March Medical Associates (Healthcare, 2026, WordPress)
- RCVMD (Nonprofit, 2026, NationBuilder)
- Bridleway (Marketplace, 2025, Next.js)
- Integrative Psych (Healthcare, 2025, Webflow)
- Chesapeake Roofing (Contractor, 2024, WordPress)
- Creekside Dentistry (Dental, 2024, WordPress)
- Chapel Hill Family & Cosmetic Dentistry (Dental, 2024, WordPress)
- Flute Society of Washington (Arts & Music, 2023, WordPress)
`;
