...
describe("ChatWindow", () => {
  ...
  it("renders messages", () => {
    ...
    expect(
      within(log).getByText(/Prices start at \$1,000/),
    ).toBeInTheDocument();
  });
  ...
  const messagesWithSources = [
    { id: "msg-1", role: "user" as const, content: "Help me" },
    {
      ...
      sources: [
        {
          url: "https://pmds.info/blog/seo",
          title: "SEO Tips",
          type: "blog" as const,
        },
        {
          url: "https://pmds.info/services",
          title: "Services",
          type: "page" as const,
        },
      ],
        ...
        messages={[
          {
            id: "m1",
            role: "assistant",
            content: "Visit **pmds** at https://pmds.info/blog today",
          },
        ]}
        isLoading={false}
        error={null}
...
describe("ChatWindow - mobile bottom sheet", () => {
  it("renders with bottom sheet classes when isMobile is true", () => {
    ...
    expect(
      container.querySelector(".claudius-bottom-sheet"),
    ).toBeInTheDocument();
  });
